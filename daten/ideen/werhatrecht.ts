...
/**
 * Sonntag · Wer hat recht? — vom Engpass zum staerksten Fach.
 *
 * Am 17.08.2026 standen hier **fuenf** Ideen, und weil `reichweiteInWochen`
 * das Minimum je Format nimmt und nicht den Durchschnitt, bestimmte dieser
 * eine Sendeplatz die Reichweite des ganzen Kanals: vier Wochen. Ein leerer
 * Sonntag haelt die Woche auf, auch wenn sechs andere Faecher ueberquellen.
 *
 * Aufgefuellt auf zehn. Der Engpass ist damit zum Montag gewandert und von
 * dort weiter — genau so soll die Rechnung wirken.
 *
 * Die Duenne war eingebaut, nicht zufaellig. Ein Streitfall braucht drei Dinge
 * gleichzeitig: zwei Lager, die es wirklich gibt, ein Drittes, das **beide**
 * uebersehen, und einen Beleg dafuer. Das ist das teuerste Material des
 * Kanals. Was beim Nachfuellen geholfen hat: **Streitfaelle sitzen dort, wo
 * eine Behoerde ihre eigene alte Empfehlung zurueckgezogen hat** — dann gibt
 * es die zwei Lager von selbst, und das Dritte ist ein Dokument, das keiner
 * von beiden gelesen hat.
 *
 * Pruefstein gegen den Dienstag: Lautet die Aufloesung „Lager A hat recht,
 * B irrt", ist es ein **Maerchen**. Hier muessen beide danebenliegen.
 *
 * Und die Formregel: Der Sonntag endet als einziger Sendeplatz **nicht** auf
 * einer Pointe, sondern auf einer Restfrage. Sonst gibt es nichts zu
 * kommentieren, und Kommentare sind bei Shorts ein Verteilungssignal.
 */
export const werhatrechtIdeen: Idee[] = [
  {
    ...
    belegpfad: [{ instanz: 'Bundesnetzagentur', art: 'behoerde', findet: 'Allgemeinzuteilung 2,4 GHz' }],
  ...
  },
  {
    ...
    belegpfad: [
      { instanz: 'Umweltbundesamt', art: 'behoerde', findet: 'Empfehlungen zu Ladestand und Wärme' },
      { instanz: 'Batterieforschung', art: 'standard', findet: 'Alterung bei hoher Ladeschlussspannung' },
    ],
    quellenIds: [],
  ...
  },
  {
    ...
    belegpfad: [
      { instanz: 'Physikalisch-Technische Bundesanstalt', art: 'behoerde', findet: 'Grundlagen zu Sensorfläche und Lichtausbeute' },
      { instanz: 'ISO', art: 'standard', findet: 'Messverfahren für Bildqualität' },
    ],
    quellenIds: [],
  },
  {
    ...
    belegpfad: [
      { instanz: 'BSI', art: 'behoerde', findet: 'Hinweise zum privaten Surfmodus und seinen Grenzen' },
      { instanz: 'Datenschutzaufsichtsbehörde', art: 'behoerde', findet: 'Aufklärung zu Tracking trotz privatem Modus' },
    ],
    quellenIds: [],
  },
  {
    ...
    belegpfad: [
      { instanz: 'Materialprüfanstalt', art: 'standard', findet: 'Trocknungsverhalten und Restfeuchte' },
      { instanz: 'Hersteller', art: 'hersteller', findet: 'Anleitung zur Behandlung von Feuchtigkeitsschäden' },
    ],
    quellenIds: [],
  ...
  },
  {
    ...
    belegpfad: [{ instanz: 'BSI', art: 'behoerde', findet: 'IT-Grundschutz ORP.4, Wegfall der Wechselempfehlung' }],
    quellenIds: [],
    notiz:
      'Der stärkste Streitfall im Vorrat: Es gibt zwei echte Lager, und das Dritte ist ein Dokument, das ' +
      'beide nicht gelesen haben. Genau die Bauform, die dieser Sendeplatz braucht.',
  },
  {
    ...
    belegpfad: [
      { instanz: 'BSI', art: 'behoerde', findet: 'Empfehlung zu Virenschutz für Privatanwender' },
      { instanz: 'BSI', art: 'behoerde', findet: 'Lagebericht zur IT-Sicherheit, Verteilung der Angriffswege' },
    ],
    quellenIds: [],
  },
  {
    ...
    belegpfad: [{ instanz: 'BSI', art: 'behoerde', findet: 'Hinweise zur Nutzung öffentlicher WLAN-Netze' }],
    quellenIds: [],
  },
  {
    ...
    belegpfad: [
      { instanz: 'Datenschutzkonferenz', art: 'behoerde', findet: 'Beschluss zu Einwilligungsbannern' },
      { instanz: 'Datenschutzaufsichtsbehörde', art: 'behoerde', findet: 'Prüfbericht zur Umsetzung von Ablehnungen' },
    ],
    quellenIds: [],
  ...
  },
  {
    ...
    belegpfad: [{ instanz: 'USB Implementers Forum', art: 'standard', findet: 'E-Marker-Pflicht und Kabelklassen' }],
    quellenIds: [],
