...
/**
 * Dienstag · Es war einmal — Regeln, die einmal richtig waren.
 *
 * Der Pruefstein dieses Sendeplatzes ist streng und rettet ihn vor dem
 * Sonntag: Die Aufloesung muss „frueher stimmte es, heute nicht" lauten.
 * Sobald **beide** Seiten etwas uebersehen, ist es ein Streitfall und gehoert
 * auf den Sonntag.
 *
...
export const eswareinmalIdeen: Idee[] = [
  {
    ...
    belegpfad: [{ instanz: 'Umweltbundesamt', art: 'behoerde', findet: 'Empfehlung zum Ladeverhalten' }],
  ...
  },
  {
    ...
    belegpfad: [
      { instanz: 'Microsoft', art: 'hersteller', findet: 'Voreinstellung „Schnelles Entfernen"' },
      { instanz: 'BSI', art: 'behoerde', findet: 'Hinweise zum Umgang mit Wechseldatenträgern' },
    ],
    quellenIds: [],
  ...
  },
  {
    ...
    belegpfad: [
      { instanz: 'JEDEC', art: 'standard', findet: 'Ausdauerangaben für Flash-Speicher' },
      { instanz: 'Microsoft', art: 'hersteller', findet: 'Warum Windows SSDs nicht defragmentiert' },
    ],
    quellenIds: [],
  },
  {
    ...
    belegpfad: [
      { instanz: 'Physikalisch-Technische Bundesanstalt', art: 'behoerde', findet: 'Aufbau und Alterung von Bildröhren' },
    ],
    quellenIds: [],
  ...
  },
  {
    ...
    belegpfad: [
      { instanz: 'BSI', art: 'behoerde', findet: 'Degaussing als Löschverfahren, Anwendbarkeit je Speichertyp' },
    ],
    quellenIds: [],
  ...
  },
  {
    ...
    belegpfad: [
      { instanz: 'Apple', art: 'hersteller', findet: 'Entwicklerdokumentation zum App-Lebenszyklus' },
      { instanz: 'Google', art: 'hersteller', findet: 'Android-Dokumentation zur Prozessverwaltung' },
      { instanz: 'Umweltbundesamt', art: 'behoerde', findet: 'Energieverbrauch mobiler Geräte im Betrieb' },
    ],
    quellenIds: [],
    notiz:
      'Die beiden Herstellerquellen sind hier ausnahmsweise die besseren — es geht um das Verhalten ihres ' +
      'eigenen Betriebssystems. Tragen darf die Aussage trotzdem nur die unbeteiligte Instanz.',
  },
  {
    id: 'flugmodus',
    format: 'eswareinmal',
    ...
    belegpfad: [
      { instanz: 'Bundesnetzagentur', art: 'behoerde', findet: 'Mobilfunknutzung in Luftfahrzeugen' },
      { instanz: 'EASA', art: 'behoerde', findet: 'Regelungen zu tragbaren elektronischen Geräten an Bord' },
    ],
    quellenIds: [],
  },
  {
    ...
    belegpfad: [
      { instanz: 'EASA', art: 'behoerde', findet: 'Freigabe tragbarer elektronischer Geräte an Bord' },
    ],
    quellenIds: [],
  ...
  },
  {
    ...
    belegpfad: [
      { instanz: 'Umweltbundesamt', art: 'behoerde', findet: 'Empfehlungen zum Laden von Lithium-Ionen-Akkus' },
    ],
    quellenIds: ['uba-akku-laden'],
  ...
  },
  {
    ...
    belegpfad: [
      { instanz: 'Normungsgremium für Speicherlaufwerke', art: 'standard', findet: 'Automatisches Parken als Bestandteil der Spezifikation' },
    ],
    quellenIds: [],
