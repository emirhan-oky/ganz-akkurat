...
export const erstesLaden: Short = {
  ...
  szenen: [
    ...
    },
    {
      ...
      art: 'zahl',
      position: 'zuspitzung',
      sprechtext: 'Ideal ist der Abbruch bei 70 Prozent. Nicht bei 100.',
      wert: '70',
      einheit: '%',
      bedeutung: 'Ideal ist der Abbruch hier – so steht es beim Umweltbundesamt.',
    ...
    },
    {
      art: 'text',
      position: 'kipppunkt',
      sprechtext: 'Sogar das Laden im ausgeschalteten Zustand empfiehlt die Behörde ausdrücklich.',
