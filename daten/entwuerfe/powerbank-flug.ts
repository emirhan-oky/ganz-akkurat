...
export const powerbankFlug: Short[] = [
  /* ─────────────────────────── 1 von 5 ─────────────────────────── */
  {
    ...
    szenen: [
      ...
      {
        art: 'cta',
        text: 'Mehr Technik fürs Handgepäck im Profil.',
        sprechtext: 'Mehr zur Technik im Handgepäck findest du in meinem Profil.',
      },
    ],
    quellenIds: QUELLE,
    texte: {
  ...
  /* ─────────────────────────── 3 von 5 ─────────────────────────── */
  {
    ...
    szenen: [
      ...
      {
        art: 'cta',
        text: 'Vorher prüfen statt am Gate abgeben.',
        sprechtext: 'Einmal vorher prüfen ist besser, als sie am Gate abzugeben.',
      },
    ],
    quellenIds: QUELLE,
    texte: {
  ...
  /* ─────────────────────────── 4 von 5 ─────────────────────────── */
  {
    ...
    szenen: [
      ...
      {
        art: 'cta',
        text: 'Mehr Reisetechnik im Profil.',
        sprechtext: 'Mehr zur Technik auf Reisen findest du in meinem Profil.',
      },
    ],
    quellenIds: QUELLE,
    texte: {
  ...
  /* ─────────────────────────── 5 von 5 ─────────────────────────── */
  {
    ...
    szenen: [
      ...
      {
        art: 'cta',
        text: 'Prüfen statt hoffen.',
        sprechtext: 'Prüfen statt hoffen. Das spart am Flughafen die meisten Nerven.',
      },
    ],
    quellenIds: QUELLE,
    texte: {
