...
export const dockKeinBild: Short[] = [
  /* ─────────────────────────── 1 von 5 ─────────────────────────── */
  {
    ...
    szenen: [
      ...
      {
        art: 'cta',
        text: 'Komplette Checkliste im angehefteten Beitrag.',
        sprechtext: 'Welche drei Angaben du vorher prüfst, steht im angehefteten Beitrag.',
      },
    ],
  ...
  /* ─────────────────────────── 2 von 5 ─────────────────────────── */
  {
    ...
    szenen: [
      ...
      {
        art: 'cta',
        text: 'Mehr Setup-Fallen im Profil.',
        sprechtext: 'Mehr solcher Fallen findest du in meinem Profil.',
      },
    ],
  ...
  /* ─────────────────────────── 3 von 5 ─────────────────────────── */
  {
    ...
    szenen: [
      ...
      {
        art: 'cta',
        text: 'Setup-Entscheidungen ohne Werbeversprechen.',
        sprechtext: 'Setup-Entscheidungen ohne Werbeversprechen findest du in meinem Profil.',
      },
    ],
  ...
  /* ─────────────────────────── 4 von 5 ─────────────────────────── */
  {
    ...
    szenen: [
      ...
      {
        art: 'cta',
        text: 'Technik, die wirklich zusammenpasst.',
        sprechtext: 'Technik, die wirklich zusammenpasst. Folg mir für mehr davon.',
      },
    ],
  ...
  /* ─────────────────────────── 5 von 5 ─────────────────────────── */
  {
    ...
    szenen: [
      ...
      {
        art: 'cta',
        text: 'Prüfen statt zurückschicken.',
        sprechtext: 'Einmal prüfen ist schneller als einmal zurückschicken.',
      },
    ],
