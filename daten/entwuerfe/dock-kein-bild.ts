...
export const dockKeinBild: Short[] = [
  {
    ...
    rubrik: 'schreibtisch',
    arbeitstitel: 'Dein Monitor ist nicht kaputt — der USB-C-Anschluss kann kein Bild',
    winkelart: 'diagnose',
    ...
    texte: {
      tiktok: {
        titel: 'Dock lädt, kein Bild? Es liegt am USB-C-Anschluss',
        beschreibung:
          'Nicht jeder USB-C-Port überträgt Bild. Ohne DisplayPort Alt Mode kommt nur Strom durch.',
        hashtags: HASHTAGS,
      },
      instagram: {
        titel: 'Dock lädt, aber kein Bild: nicht der Monitor, der USB-C-Anschluss',
        beschreibung:
