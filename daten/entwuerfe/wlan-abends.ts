...
export const wlanAbends: Short[] = [
  {
    ...
    themaId: 'wlan-abends',
    rubrik: 'zuhause',
    arbeitstitel: 'Dein Router ist nicht zu alt. Deine Nachbarn sind nur alle online.',
    winkelart: 'mythos',
    ...
    texte: {
      tiktok: {
        titel: 'Dein Router ist nicht zu alt. Die Nachbarn sind alle online.',
        beschreibung:
          'Das 2,4-GHz-Band teilst du dir mit der ganzen Nachbarschaft. Abends sind alle gleichzeitig drauf.',
        hashtags: HASHTAGS,
      },
      instagram: {
        titel: 'WLAN wird abends langsamer: Nicht der Router, die Nachbarn',
        beschreibung:
